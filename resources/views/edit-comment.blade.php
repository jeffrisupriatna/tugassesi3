                        ...
                        <form action="{{ route('EditComment') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                    <div class="form-floating">
                                        <input class="form-control" name="nama" type="text" value="{{ $comment->nama }}" placeholder="Enter name" />
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="komentar" type="text" value="{{ $comment->komentar }}" placeholder="Enter komentar" />
